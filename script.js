...
function gameOver(a) {
  var gameOverAlertElement = '<b>WHOOPS! GOOD GAME </b><br><br> Player ' + span[a].dataset.player.toUpperCase() + ' WIN ^^ <br><br>' + restartButton;
...
function draw() {
  var drawAlertElement = '<b> Draw O.O </b> <br><br>' + restartButton;
  var div = document.createElement('div');
  div.className = 'alert';
